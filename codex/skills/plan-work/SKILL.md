...
/plan-work "feature description" --mode ceo          Greenfield/product plan
/plan-work "feature description" --mode eng          Fix/refactor/small feature plan
/plan-work "feature description" --spec              Richer spec output
/plan-work "feature description" --out plans/foo.md  Custom output path
/plan-work "fix findings" --review reports/review.md Seed with review findings
/plan-work "add caching" --branch develop            Use non-main baseline
/plan-work "feature" --dry-run                       Show references that would load
...
1. Produce a file that `/orchestrate` can parse: `## Wave N: ...` sections with
   `### W{N}-{NN}: ...` work units.
