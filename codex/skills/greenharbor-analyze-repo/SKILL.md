...
description: Perform a comprehensive multi-phase technical analysis of a git repository. Use when the user wants to understand a codebase deeply, analyze repository architecture, generate a technical report, or says "greenharbor-analyze-repo", "analyze this repo", "analyze codebase", "repo analysis", or "technical report".
---
