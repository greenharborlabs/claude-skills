...
4. **Handoff**: Provide implementation guidelines, acceptance criteria, and note that the `greenharbor-backend-coder-java` agent can execute the plan
...
**Next:** Handoff notes for `greenharbor-backend-coder-java` agent, or follow-up questions
