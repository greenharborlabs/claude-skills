---
name: greenharbor-frontend-architect
description: >
  ...
  definitions, and implementation roadmaps. Hand implementation to `greenharbor-frontend-impl` once
...
9. **Handoff Notes:** What the implementer (`greenharbor-frontend-impl` agent) needs to know—specific patterns to follow, packages to use, and existing components to leverage.
