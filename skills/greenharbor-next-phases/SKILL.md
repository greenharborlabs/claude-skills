...
Examples:
  ...
  /greenharbor-next-phases ~/code/other-project
  /greenharbor-next-phases --out docs/audit-report.md
  /greenharbor-next-phases --stack java --deep-review
  /greenharbor-next-phases --agent greenharbor-backend-planning-architect
```
...
- **Implementation Outline:** Where to change/add code (directories, modules, files). Key steps. Specify which agent type is best suited (e.g., greenharbor-backend-coder-java, greenharbor-frontend-impl, greenharbor-nanoclaw-coder).
- **Acceptance Criteria:** Testable conditions that define done
- **Plan-Work Input:** `/greenharbor-plan-work "one-line description suitable for generating an implementation plan"`
...
item: greenharbor-backend-coder-java, greenharbor-backend-reviewer-java, greenharbor-backend-debugger-java.
...
item: greenharbor-frontend-impl, greenharbor-frontend-architect, greenharbor-frontend-reviewer.
