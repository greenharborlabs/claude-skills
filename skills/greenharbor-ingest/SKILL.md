...
```text
greenharbor-ingest ~/Downloads/attention-paper.pdf
greenharbor-ingest https://example.com/api-docs --internal
greenharbor-ingest spec.docx --title "API Specification v2"
