...
This shows an example of what the `/greenharbor-ingest` skill creates when processing a document.

## Example Session

**User input:**
```
/greenharbor-ingest ~/Downloads/rest-api-design-guide.pdf --title "REST API Design Best Practices"
```
...
```
/greenharbor-ingest ~/work/auth-service-spec.md --internal
```
...
```
/greenharbor-ingest paper.pdf --dry-run
```
